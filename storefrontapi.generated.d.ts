  ...
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        ...
        highlightBadge?: StorefrontAPI.Maybe<
...
export type DashboardProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type DashboardProductsQuery = {
...
> & {
  ...
  techStack?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  highlightBadge?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
};
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n    query DashboardProducts($country: CountryCode, $language: LanguageCode)\n      @inContext(country: $country, language: $language) {\n      products(first: 10, sortKey: UPDATED_AT, reverse: true) {\n        nodes {\n          title\n          handle\n        }\n      }\n    }\n  ': {
    return: DashboardProductsQuery;
    variables: DashboardProductsQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
